...
public class AllSensorsPlugin implements FlutterPlugin {
  ...
  private void setupEventChannels(Context context, BinaryMessenger messenger) {
    ...
    final StreamHandlerImpl proximityStreamHandler = new StreamHandlerImpl((SensorManager)context.getSystemService(context.SENSOR_SERVICE), Sensor.TYPE_PROXIMITY,
